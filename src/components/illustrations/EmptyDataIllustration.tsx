...
export function EmptyInboxIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <circle cx="100" cy="118" r="22" stroke="rgba(79,111,82,0.35)" strokeWidth="2" />
      <path
        d="M92 118l6 6 12-14"
        stroke="rgba(79,111,82,0.85)"
        strokeWidth="3"
        strokeLinecap="round"
    ...
    <svg className={className} viewBox="0 0 200 160" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <defs>
        <linearGradient id="g" x1="48" y1="104" x2="156" y2="72" gradientUnits="userSpaceOnUse">
          <stop stopColor="rgba(79,111,82,0.2)" />
          <stop offset="1" stopColor="rgba(79,111,82,0.85)" />
        </linearGradient>
      </defs>
      <circle cx="48" cy="104" r="4" fill="rgba(79,111,82,0.9)" />
      ...
      <circle cx="156" cy="80" r="4" fill="rgba(79,111,82,0.75)" />
    </svg>
  );
}
