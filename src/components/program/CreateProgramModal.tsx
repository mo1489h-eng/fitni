...
const CreateProgramModal = ({ open, onOpenChange, onSubmit }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="!flex max-h-[100dvh] min-h-0 w-[calc(100%-2rem)] max-w-md flex-col gap-0 overflow-hidden p-0 sm:max-h-[90vh]"
        dir="rtl"
      >
        <DialogHeader className="flex-shrink-0 space-y-1.5 border-b border-border px-6 pb-3 pt-6 text-right">
