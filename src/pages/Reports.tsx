...
import {
  ...
  CheckCircle, XCircle, Clock, Lock, FileText, Download,
} from "lucide-react";
  ...
  const handleDownloadAll = async () => {
    ...
    try {
      ...
      clients.forEach((client) => {
        const pdfData = generateClientPdf(client);
        zip.file(`${client.name}_report.pdf`, pdfData);
      });
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              ...
              disabled={clients.length === 0 || downloadingAll}
            >
