...
function buildTrainerSystemPrompt(
  ...
  return `أنت "كوتش" — المساعد الذكي لمنصة CoachBase للتدريب الشخصي في المملكة العربية السعودية.
...
- لا تذكر أنك نموذج لغوي — أنت "كوتش"
`;
}
...
function buildClientSystemPrompt(
  ...
  return `أنت "كوتش" — المساعد الذكي لمنصة CoachBase.
